...
class __Mustache_24ba8c8ccacd3316c6f54f01d0235574 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '        <li>
';
        $buffer .= $indent . '                        <a class="list-group-item list-group-item-action  " href="http://assessments.xs.edu.ph/grade/report/overview/index.php" data-key="privatefiles" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="70" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="1">
';
...
';
        $buffer .= $indent . '                                            <i class="icon fa fa-table fa-fw " aria-hidden="true"  ></i>
';
        $buffer .= $indent . '                                        </span>
';
        $buffer .= $indent . '                                    <span class="media-body ">Grades</span>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
...
';
        $buffer .= $indent . '                    <li>
';
        $buffer .= $indent . '                        <a class="list-group-item list-group-item-action  " href="http://assessments.xs.edu.ph/message/index.php" data-key="privatefiles" data-isexpandable="0" data-indent="0" data-showdivider="0" data-type="70" data-nodetype="0" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="1">
';
        $buffer .= $indent . '                            <div class="ml-0">
';
        $buffer .= $indent . '                                <div class="media">
';
        $buffer .= $indent . '                                        <span class="media-left">
';
        $buffer .= $indent . '                                            <i class="icon fa fa-comment fa-fw " aria-hidden="true"  ></i>
';
        $buffer .= $indent . '                                        </span>
';
        $buffer .= $indent . '                                    <span class="media-body ">Messages</span>
';
        $buffer .= $indent . '                                </div>
';
        $buffer .= $indent . '                            </div>
